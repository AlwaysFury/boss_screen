...
import static com.boss.common.constant.MQPrefixConst.ORDER_EXCHANGE;
...
//    }
    ...
    @Override
    public void refreshOrders(RefreshDTO refreshDTO) {
        log.info("开始向mq推送订单刷新消息");
        try {
            rabbitTemplate.convertAndSend(ORDER_EXCHANGE, "*", new Message(JSON.toJSONBytes(refreshDTO), new MessageProperties()));
        } catch (Exception e) {
